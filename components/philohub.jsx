        ...
        <Section title="🔥 Trending Activities" action="See all" onAction={() => onNavigate("activities")} T={T}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: "1rem" }}>
            {trending.map((a, i) => {
              ...
              return (
                <div key={a.id} onClick={() => onNavigate("activity", a)} style={{ position: "relative", borderRadius: 14, overflow: "hidden", cursor: "pointer", height: 180, animation: `fadeUp 0.5s ease ${i*80}ms both`, transition: "transform 0.2s ease" }}
          ...
          <div style={{ display: "flex", gap: "1rem", overflowX: "auto", paddingBottom: "0.5rem", scrollbarWidth: "none" }}>
            {books.slice(0, 8).map((b, i) => (
              <div key={b.id} style={{ minWidth: 130, flexShrink: 0, cursor: "pointer", animation: `fadeUp 0.5s ease ${i*60}ms both` }}>
                <div style={{ width: 130, height: 190, borderRadius: 8, overflow: "hidden", marginBottom: "0.6rem", background: T.surface2, position: "relative", transition: "transform 0.2s" }}
